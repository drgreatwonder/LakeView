  ...
  <body class="getbody p-5 m-5">
      ...
      <div class="row">
            ...
            <div class="mb-4">
              ...
              <input type="text" class="form-control" name="housenumber" placeholder="Enter Property Name" required/>
              </div>
            ...
            <div class="mb-4">
              ...
              <input type="date" class="form-control" name="buildyear" required/>
            </div>
