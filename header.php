    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
        <ul class="navbar-nav mr-auto smooth-scroll">
          ...
          <li class="nav-item">
            <a class="nav-link" href="#opinions" data-offset="30">Logout</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="dashboard.php" data-offset="90">Dashboard</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#contact" data-offset="90">Contact Us</a>
          </li>
        </ul>-->
        <!-- Social Icon  -->
      <!-- </div>
